...
public interface ActivitiesTypeData<T> {
    ...
    T getDataOfDayBetweenTwoTimePerMinute(String activityType, String date, String endDate, String startTime, String endTime, String accessToken) throws IOException;
