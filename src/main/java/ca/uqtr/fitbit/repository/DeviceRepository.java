...
public interface DeviceRepository extends CrudRepository<Device, UUID> {
    ...
    @Query("select d from Device d left join fetch d.patientDevices pd where pd.medicalFileId = :patientDevice AND pd.returnedAt IS NOT NULL ORDER BY pd.id DESC ")
